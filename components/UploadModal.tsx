...
const Page = ({ isOpen, onClose, onUploadSuccess }: UploadModalProps) => {
    ...
    >
      ...
      >
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-800">
           <h1 className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">Upload</h1>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          ...
          <button
            ...
            className="w-full text-white cursor-pointer mt-4 p-3 text-lg font-semibold bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 shadow-lg shadow-purple-500/50 hover:shadow-xl hover:shadow-purple-500/60 transition-all duration-300 normal-case rounded-xl disabled:bg-gray-400 disabled:cursor-not-allowed font-medium"
          >
