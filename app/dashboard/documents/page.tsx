    ...
    <div className="mb-5">
      ...
      <main className="max-w-7xl mx-auto p-8">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">Documents</h1>
          <button
            onClick={() => setShowUploadModal(true)}
            className=" text-white cursor-pointer mt-4 p-4 text-lg font-semibold bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 shadow-lg shadow-purple-500/50 hover:shadow-xl hover:shadow-purple-500/60 transition-all duration-300 normal-case rounded-xl"
          >
            Upload Document
          </button>
        </div>
